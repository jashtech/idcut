<?php
/*
 * 2015 Jash Technologie Sp. z o. o.
 *
 * NOTICE OF LICENSE
 *
 ...
 * https://github.com/jashtech/idcut/blob/master/LICENSE
 *
 *  @author    Jash Technologie Sp. z o. o. http://www.jash.fr
 *  @copyright Jash Technologie Sp. z o. o. http://www.jash.fr
...
class IDcut extends PaymentModule
{
    ...
    {
        $this->name             = 'idcut';
        $this->author           = 'Jash Technologie jash.fr';
